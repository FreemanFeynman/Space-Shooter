...
import { playSound } from '../utils/sounds.js'; // Import playSound function
import { fireMissile } from '../entities/projectiles.js'; // Import missile creation from projectiles.js
...
const nemesisImages = Array.from({ length: 10 }, (_, i) => {
  const img = new Image();
  img.src = `../assets/images/nemesis_${i + 1}.png`;
